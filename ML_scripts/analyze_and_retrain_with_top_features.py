...
print(f"✓ Holdout data: {holdout_data.shape}")
...
print(f"\n✓ Selected top {top_n} most important features:")
...
print(f"\n✓ Cumulative importance of top {top_n}: {cumulative_importance:.4f} ({(cumulative_importance/total_importance)*100:.2f}%)")
...
print("\n✓ Training MLPClassifier with top features...")
